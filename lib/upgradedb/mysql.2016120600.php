...
$this->Execute("ALTER TABLE divisions ADD CONSTRAINT `divisions_location_city_id_fk` FOREIGN KEY (location_city) REFERENCES location_cities (id) ON UPDATE CASCADE ON DELETE SET NULL");
$this->Execute("ALTER TABLE divisions ADD COLUMN location_street int(11) DEFAULT NULL");
$this->Execute("ALTER TABLE divisions ADD CONSTRAINT `divisions_location_street_id_fk` FOREIGN KEY (location_street) REFERENCES location_streets (id) ON UPDATE CASCADE ON DELETE SET NULL");
